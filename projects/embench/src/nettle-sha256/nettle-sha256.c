...
int
nettle_sha256_verify (int res __attribute ((unused)))
{
  bool correct = true;
...
void
nettle_sha256_init (void)
{
}


static int nettle_sha256_body (int  rpt);

void
nettle_sha256_warm (int  heat)
{
  int  res = nettle_sha256_body (heat);
...
int
nettle_sha256_run (void)
{
  return nettle_sha256_body (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


static int __attribute__ ((noinline))
nettle_sha256_body (int rpt)
{
  int i;
