...
int
nettle_aes_verify (int res __attribute ((unused)))
{
  bool correct = true;
...
void
nettle_aes_init (void)
{
}


static int nettle_aes_body (int  rpt);

void
nettle_aes_warm (int  heat)
{
  int  res = nettle_aes_body (heat);
...
nettle_aes_run (void)
{
  return nettle_aes_body (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


static int __attribute__ ((noinline))
nettle_aes_body (int rpt)
{
  int i;
