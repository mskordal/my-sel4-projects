...
int
libpicojpeg_test_verify (int res __attribute ((unused)))
{
...
void
libpicojpeg_test_init (void)
{
}


static int libpicojpeg_test_body (int  rpt);

void
libpicojpeg_test_warm (int  heat)
{
  int  res = libpicojpeg_test_body (heat);
...
int
libpicojpeg_test_run (void)
{
  return libpicojpeg_test_body (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


static int __attribute__ ((noinline))
libpicojpeg_test_body (int rpt)
{
  int i;
