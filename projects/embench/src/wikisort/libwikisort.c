...
int
libwikisort_verify (int res __attribute ((unused)))
{
  Test exp[] = {
...
void
libwikisort_init (void)
{
}


static int libwikisort_body (int  rpt);

void
libwikisort_warm (int  heat)
{
  int  res = libwikisort_body (heat);
...
int
libwikisort_run (void)
{
  return libwikisort_body (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


static int __attribute__ ((noinline))
libwikisort_body (int rpt)
{
