...
static int libslre_body (int  rpt);

void
libslre_warm (int  heat)
{
  int  res = libslre_body (heat);
...
libslre_run (void)
{
  return libslre_body (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


static int __attribute__ ((noinline))
libslre_body (int rpt)
{
  volatile int ret;
  int j;
