...
static int combined_body (int  rpt);

void
combined_warm (int  heat)
{
  int  res = combined_body (heat);
...
combined_run (void)
{
  return combined_body (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


static int __attribute__ ((noinline))
combined_body (int rpt)
{
  volatile int cnt;
  int i;
