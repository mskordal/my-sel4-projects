...
void
libsichneu_init (void)
{
}


static int libsichneu_body (int  rpt);

void
libsichneu_warm (int  heat)
{
  int  res = libsichneu_body (heat);
...
libsichneu_run (void)
{
  return libsichneu_body (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


/**void NSicherNeu()**/
static int __attribute__ ((noinline))
libsichneu_body (int rpt)
{
  int j;
