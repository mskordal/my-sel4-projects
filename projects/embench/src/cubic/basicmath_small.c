...
int
basicmath_small_verify (int res __attribute ((unused)) )
{
...
void
basicmath_small_init (void)
{
}


static int basicmath_small_body (int  rpt);

void
basicmath_small_warm (int  heat)
{
  int  res = basicmath_small_body (heat);
...
int
basicmath_small_run (void)
{
  return basicmath_small_body (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


static int
basicmath_small_body (int rpt)
{
  int  i;
