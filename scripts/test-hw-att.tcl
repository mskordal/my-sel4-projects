...
# 0x20 7b725fb4
# 0x30 3bfb3fb4
# Keys are written every 48 (0x30) bytes so each key can be up to 384 bits
mwr -force 0xa0040000 0x3
mwr -force 0xa0040008 0x1afd5fb0
mwr -force 0xa004000c 0x18

mwr -force 0xa0040040 0x4
mwr -force 0xa0040048 0xebd55fb4
mwr -force 0xa004004c 0x81

#mwr -force 0xa0040080 0x5
#mwr -force 0xa0040088 0x3b7a9fb4
#mwr -force 0xa004008c 0x10

#mwr -force 0xa00400C0 0x6
#mwr -force 0xa00400C8 0x7b725fb4
#mwr -force 0xa00400Cc 0x20
...
mwr -force 0xa0000018 0x0
set ctrl_val [mrd -force -value 0xa0000000]
set ctrl_val [expr $ctrl_val | 0x1]
mwr -force 0xa0000000 $ctrl_val
after 2000

mrd -force 0xa0040000
